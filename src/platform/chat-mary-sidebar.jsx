  ...
  const quickActions = [
    {
      ...
      prompts: [
        "Автоматизируй отдел продаж по запросу — подбери AI-агентов и запусти процессы",
        "Собери команду агентов под отдел и отдай им рутину: заявки, отчёты, задачи",
        "Запусти полный цикл — от заявки до задачи менеджеру — без ручной работы",
      ],
    },
    {
      label: "Добавить сотрудника в отдел",
      icon: <I d={<><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M19 8v6" /><path d="M22 11h-6" /></>} size={15} />,
      prompts: [
        "Добавь нового сотрудника в отдел продаж",
        "Заведи карточку сотрудника и назначь роль в команде",
        "Перемести сотрудника в другой отдел",
      ],
    },
    {
    ...
    },
    {
      ...
      icon: <I d={<><path d="M9 2v6" /><path d="M15 2v6" /><path d="M7 8h10v3a5 5 0 0 1-10 0V8z" /><path d="M12 16v6" /></>} size={15} />,
      prompts: [
        "Подключи Telegram-канал к платформе",
        "Настрой интеграцию с CRM для отдела продаж",
        "Покажи доступные интеграции и что уже подключено",
      ],
    },
  ];
